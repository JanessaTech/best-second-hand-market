...
export default function HomeContent() {
    ...
    const {wallet, menuOpen, eventsBus, toggleMenu, notifyFilterUpdate, notifyAlertUpdate, notifyWalletOpen, notifyShowMenu, notifyNetworkCheck} = React.useContext(GlobalVariables)
